...
'''print("the value of z is", z+1)'''  # THis will give
#
#
#


# error becoz z which is a string is being added to a integer
print("the value of z is", int(z)+1)  # THis will give output coz first z is converted into the same data type
